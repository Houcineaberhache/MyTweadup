            ...
            <div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="{{route('ajouter.groupe')}}">Ajouter groupe</a>
						</li>
					</ul>
				</div>
                <div class="col-md-6">
                    <form method="get" action="/searchgroupe">
                        @csrf
                        <div class="form-input">
                            <input type="search" name="search" placeholder="titre_formation/date" value="{{ isset($search) ? $search : '' }}">
                ...
                <table class="table table-bordered table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $groupe->formateur->nom ?? 'sans' }} {{ $groupe->formateur->prenom ?? 'sans' }}</td>
                            <td>{{ $groupe->formation->titre ?? 'sans' }}</td>
                        ...
                        <div class="action-dots float-end">
                            <div class="d-flex justify-content-center mx-3"> <!-- Center the buttons and add margin on the y-axis -->
                                <a class="btn btn-warning me-2" href="{{route('groupe.edit',$groupe->id)}}"> <!-- Add margin to the right of the button -->

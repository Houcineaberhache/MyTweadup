...
<head>
    ...
    <title>My Tweadup | les depenses</title>
        ...
        <main>
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="{{route('ajouter.depense')}}">Ajouter depense</a>
						</li>
					</ul>
				</div>
                
            <div class="col-md-6">
                    <form method="get" action="/searchdepense">
                        @csrf
                        <div class="form-input">
                            <input type="search" name="search" placeholder="categorie/nature/created_at/" value="{{ isset($search) ? $search : '' }}">
            ...
            <thead class="thead-dark">
                <tr>
                    ...
                    <th scope="col">La nature de depense</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>@if($depense->categorie_depense == 'divers')
                                {{ $depense->nature_depense }}
                            @else
                                -
                            @endif
                    </td>
                    ...
                    <td class="action-dots">
                        <div class="action-dots float-end">
                            <div class="d-flex justify-content-center mx-3"> <!-- Center the buttons and add margin on the y-axis -->
                                <a class="btn btn-warning"  href="{{route('depense.edit',$depense->id)}}"> <!-- Add margin to the right of the button -->

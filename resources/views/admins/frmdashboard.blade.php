...
<head>
    ...
    <title>My Tweadup | les formateurs</title>
        ...
        <main>
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="{{route('formateur.registration')}}">Ajouter formateur</a>
						</li>
					</ul>
				</div>
                <div class="col-md-6">
                    <form method="get" action="/searchformateur">
                        @csrf
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $formateur->formation->titre ?? '' }}</td>
                    <td>{{ $formateur->CIN }}</td>
                    ...
                    <td>
                        <div class="action-dots float-end">
                            <div class="d-flex justify-content-center mx-3"> <!-- Center the buttons and add margin on the y-axis -->
                                <a class="btn btn-warning me-2" href="{{route('formateur.edit',$formateur->id)}}"> <!-- Add margin to the right of the button -->
                                <i class='bx bxs-edit'></i>                                </a> 
                                <form method="POST" action="{{ route('formateur.destroy', $formateur->id) }}">
                                    @csrf
                                    @method('DELETE')  

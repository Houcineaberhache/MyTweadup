...
<head>
    ...
    <title>My Tweadup | les employees</title>
			...
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="{{route('employee.registration')}}">Ajouter Employé</a>
						</li>
					</ul>
				</div>
                <div class="col-md-6">
                    ...
                    <td>
                        <div class="action-dots float-end">
                            <div class="d-flex justify-content-center mx-3"> <!-- Center the buttons and add margin on the y-axis -->
                                <a class="btn btn-warning me-2" href="{{route('employee.edit',$employee->id)}}"> <!-- Add margin to the right of the button -->

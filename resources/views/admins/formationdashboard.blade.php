...
<head>
    ...
    <title>My Tweadup | les formations</title>
			...
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="{{route('ajouter.formation')}}">Ajouter formation</a>
						</li>
                        <li><i class='bx bx-chevron-right' ></i></li>
						<li>
							<a class="active" href="{{route('calendar.index')}}">Voir calendrier</a>
						</li>
					</ul>
				</div>
                
                
                    <form method="get" action="/searchformation">
                        @csrf
                        <div class="form-input">
                            <input type="search" name="search" placeholder="date_debut/titre" value="{{ isset($search) ? $search : '' }}">
                    ...
                    <td>
                        <div class="action-dots float-end">
                            <div class="d-flex justify-content-center mx-3"> <!-- Center the buttons and add margin on the y-axis -->
                                <a class="btn btn-warning me-2" href="{{route('formation.edit',$formation->id)}}"> <!-- Add margin to the right of the button -->

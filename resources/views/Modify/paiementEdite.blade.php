...
<html>
   <head>
    <title>My Tweadup | Modifier Paiement</title> 
                        ...
                        <div class="col-lg-9">
                            <div class="card border-0 shadow mb-4">
                                <div class="card-body card-form p-4">
                                    <h3 class="fs-4 mb-4 text-center">Modifier Paiement</h3>
                                    <form action="{{ route('paiement.update',$paiement->id) }}" method="POST" id="paymentForm">
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                    ...
                                                    <select name="groupe_id" class="form-select form-control">
                                                        ...
                                                        @foreach ($groupes as $groupe)
                                                            <option value="{{ $groupe->id }}" {{ (old('groupe_id', $paiement->groupe_id) == $groupe->id) ? 'selected' : '' }}>
                                                                {{ $groupe->nom_groupe }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="number" class="form-control" name="prix_total" id="prix_total" value="{{old('prix_total',$paiement->prix_total)}}" required>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label">La somme payée (DH)</label>
                                                <input type="number" class="form-control" name="somme" id="somme" value="{{old('somme',$paiement->somme)}}" required>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label">La remise (DH)</label>
                                                <input type="number" class="form-control" name="remise" id="remise" value="{{old('remise',$paiement->remise)}}"required>
                                            </div>

...
<html>
   <head>
    <title>My Tweadup | Modifier Formation</title> 
                ...
                <div class="col-lg-9">
                    <div class="card border-0 shadow mb-4">
                        <div class="card-body card-form p-4">
                            <h3 class="fs-4 mb-4 text-center">Modifier Formation</h3>
                            <form method="POST" action="{{ route('formation.update',$formation->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="titre" id="event_name" class="form-control" value="{{old('titre',$formation->titre)}}">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Durée</label>
                                        <input type="text" class="form-control" name="duree" value="{{old('duree',$formation->duree)}}">
                                        @error('duree')
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="prix" value="{{old('prix',$formation->prix)}}">
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                            <label class="form-label">Changer la Couleur:</label>
                                            <select type="text" id="eventColor" class="form-control" name="couleur">
                                                
                                            <option value="rouge" {{ (old('couleur', $formation->couleur) == 'rouge') ? 'selected' : '' }}>rouge</option>
                                            <option value="vert" {{ (old('couleur', $formation->couleur) == 'vert') ? 'selected' : '' }}>vert</option>
                                            <option value="cyan" {{ (old('couleur', $formation->couleur) == 'cyan') ? 'selected' : '' }}>cyan</option>
                                            <option value="bleu" {{ (old('couleur', $formation->couleur) == 'bleu') ? 'selected' : '' }}>bleu</option>
                                            <option value="violet" {{ (old('couleur', $formation->couleur) == 'violet') ? 'selected' : '' }}>violet</option>
                                            <option value="orange" {{ (old('couleur', $formation->couleur) == 'orange') ? 'selected' : '' }}>orange</option>
                                            <option value="jaune" {{ (old('couleur', $formation->couleur) == 'jaune') ? 'selected' : '' }}>jaune</option>
                                            </select>
                                            @error('couleur')
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">  
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="date_debut" id="event_end_date" class="form-control" value="{{old('date_debut',$formation->date_debut)}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">  
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="date_fin" id="event_end_date" class="form-control" value="{{old('date_fin',$formation->date_fin)}}">
                                            </div>
                                        </div>

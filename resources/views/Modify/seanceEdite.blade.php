...
<html>
   <head>
    <title>My Tweadup | Modifier Seance</title> 
                ...
                <div class="col-lg-9">
                    <div class="card border-0 shadow mb-4">
                        <div class="card-body card-form p-4">
                            <h3 class="fs-4 mb-4 text-center">Modifier  Seance</h3>
                            <form method="POST" action="{{route('seance.update',$seance->id)}}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="date" class="form-control" name="date" value="{{old('date',$seance->date)}}">
                                        @error('date')
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="duree" value="{{old('duree',$seance->duree)}}">
                                        @error('duree')
                                        <div class="text-danger">
                                            {{$message}}
                                        </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="time" class="form-control" name="horaire" value="{{old('horaire',$seance->horaire)}}">
                                        @error('horaire')
                                        <div class="text-danger">
                                            {{$message}}
                                        </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select form-control" name="salle" value="{{old('salle',$seance->salle)}}">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Saisir une formateur</label>
                                        <select name="formateur_id" class="form-select form-control">
                                            <option value="">Sélectionner un formateur</option>
                                            @foreach ($formateurs as $formateur)
                                                <option value="{{ $formateur->id }}" {{ (old('formateur_id', $seance->formateur_id) == $formateur->id) ? 'selected' : '' }}>

...
<html>
   <head>
    <title>My Tweadup | Modifier Groupe</title> 
                ...
                <div class="col-lg-9">
                    <div class="card border-0 shadow mb-4">
                        <div class="card-body card-form p-4">
                            <h3 class="fs-4 mb-4 text-center">Modifier Groupe</h3>
                                        ...
                                        <input type="text" class="form-control" name="nom_groupe" value="{{old('nom_groupe',$groupe->nom_groupe)}}">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                        ...
                                        <select name="formateur_id" class="form-select form-control">
                                            ...
                                            @foreach ($formateurs as $formateur)
                                                <option value="{{ $formateur->id }}" {{ (old('formateur_id', $groupe->formateur_id) == $formateur->id) ? 'selected' : '' }}>

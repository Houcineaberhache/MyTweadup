                ...
                <div class="col-lg-9">
                    <div class="card border-0 shadow mb-4">
                        <div class="card-body card-form p-4">
                            <h3 class="fs-4 mb-4 text-center">Modifier étudiant</h3>
                                ...
                                <fieldset class="fieldset-border">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="CIN" value="{{old('CIN',$etudiant->CIN)}}">
                                            @error('CIN')
                                            <div class="text-danger">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="email" class="form-control" name="email" value="{{old('email',$etudiant->email)}}">
                                            @error('email')
                                            <div class="text-danger">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea name="adresse" class="form-control" value="{{old('adresse',$etudiant->adresse)}}"></textarea>
                                            @error('adresse')
                                            <div class="text-danger">
                                                {{ $message }}
                                            </div>
                                ...
                                <fieldset class="fieldset-border">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="formation_id" class="form-select form-control">
                                            ...
                                            @foreach ($formations as $formation)
                                                <option value="{{ $formation->id }}" {{ (old('formation_id', $etudiant->formation_id) == $formation->id) ? 'selected' : '' }}>
                                                    {{ $formation->titre }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select name="type_paiement" class="form-select form-control">
                                                <option value="total" {{ (old('type_paiement', $etudiant->type_paiement) == 'total') ? 'selected' : '' }}>Total</option>
                                                <option value="partiel" {{ (old('type_paiement', $etudiant->type_paiement) == 'partiel') ? 'selected' : '' }}>Partiel</option>
                                                <option value="Mensuel" {{ (old('type_paiement', $etudiant->type_paiement) == 'Mensuel') ? 'selected' : '' }}>Mensuel</option>
                                            </select>
                                            @error('type_paiement')

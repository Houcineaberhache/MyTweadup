...
<html>
   <head>
    <title>My Tweadup | Modifier Formateur</title> 
                ...
                <div class="col-lg-9">
                    <div class="card border-0 shadow mb-4">
                        <div class="card-body card-form p-4">
                            <h3 class="fs-4 mb-4 text-center">Modifier Formateur</h3>
                            <form method="POST" action="{{route('formateur.update',$formateur->id)}}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="nom" value="{{old('nom',$formateur->nom)}}">
                                        @error('nom')
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="prenom" value="{{old('prenom',$formateur->prenom)}}">
                                        @error('prenom')
                                        <div class="text-danger">
                                            {{$message}}
                                        </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="CIN" value="{{old('CIN',$formateur->CIN)}}">
                                        @error('CIN')
                                        <div class="text-danger">
                                            {{$message}}
                                        </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="email" class="form-control" name="email" value="{{old('email',$formateur->email)}}">
                                        @error('email')
                                        <div class="text-danger">
                                            {{$message}}
                                        </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <textarea name="adresse" class="form-control" value="{{old('adresse',$formateur->adresse)}}"></textarea>
                                        @error('adresse')
                                        <div class="text-danger">
                                            {{$message}}
                                        </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="formation_id" class="form-select form-control">
                                            ...
                                            @foreach ($formations as $formation)
                                                <option value="{{ $formation->id }}" {{ (old('formation_id', $formateur->formation_id) == $formation->id) ? 'selected' : '' }}>
                                                    {{ $formation->titre }}
                                                </option>
                                            @endforeach
                                        </select>

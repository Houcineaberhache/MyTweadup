...
<html>
   <head>
    <title>My Tweadup | Modifier Depense</title> 
                ...
                <div class="col-lg-9">
                    <div class="card border-0 shadow mb-4">
                        <div class="card-body card-form p-4">
                            <h3 class="fs-4 mb-4 text-center">Modifier Depense</h3>
                            <form method="POST" action="{{ route('depense.update',$depense->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                <div class="col-md-6 mb-3">
                                        ...
                                        <select id="categorie_depense" name="categorie_depense" class="form-control" value="{{old('categorie_depense',$depense->categorie_depense)}}">
                                            <option value="location" {{ (old('categorie_depense', $depense->categorie_depense) == 'location') ? 'selected' : '' }}>Location</option>
                                            <option value="eau" {{ (old('categorie_depense', $depense->categorie_depense) == 'eau') ? 'selected' : '' }}>L'eau</option>
                                            <option value="eau potable" {{ (old('categorie_depense', $depense->categorie_depense) == 'eau potable') ? 'selected' : '' }}>L'eau potable</option>
                                            <option value="impression" {{ (old('categorie_depense', $depense->categorie_depense) == 'impression') ? 'selected' : '' }}>Impression</option>
                                            <option value="nettoyage" {{ (old('categorie_depense', $depense->categorie_depense) == 'nettoyage') ? 'selected' : '' }}>Nettoyage</option>
                                            <option value="electricite" {{ (old('categorie_depense', $depense->categorie_depense) == 'electricite') ? 'selected' : '' }}>Électricité</option>
                                            <option value="divers" {{ (old('categorie_depense', $depense->categorie_depense) == 'divers') ? 'selected' : '' }}>Divers</option>
                                        </select>
                                    </div>

                                    <div class="col-md-6 mb-3">
                                        <label class="form-label" for="event_name">Nature de depense </label>
                                        <input type="text" name="nature_depense" id="nature_depense" class="form-control" value="{{old('nature_depense',$depense->nature_depense)}}" >
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label" for="event_name">Montant de depenses </label>
                                        <input type="text" name="montant_depense" id="montant_depense" class="form-control" value="{{old('montant_depense',$depense->montant_depense)}}">
                                    </div>

                                </div>
                                <div class="d-grid">
                                    <button type="submit" class="btn btn-primary">Modifier depense</button>
                                </div>
                            </form>
                        </div>
                    </div>
